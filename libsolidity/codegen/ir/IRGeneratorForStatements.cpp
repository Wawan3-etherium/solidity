...
bool IRGeneratorForStatements::visit(Assignment const& _assignment)
{
	...
	solAssert(!TokenTraits::isShiftOp(binaryOperator) || type(_assignment.rightHandSide()).mobileType(), "");
	_assignment.leftHandSide().accept(*this);

	IRVariable value =
		TokenTraits::isShiftOp(binaryOperator) ?
		convert(_assignment.rightHandSide(), *type(_assignment.rightHandSide()).mobileType()) :
